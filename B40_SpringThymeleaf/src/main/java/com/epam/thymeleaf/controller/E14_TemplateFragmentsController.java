...
@Controller
public class E14_TemplateFragmentsController {

	@GetMapping("/e14templatefragments")
	public String getTemplateFragmentsPage(Model model) {

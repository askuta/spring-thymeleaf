...
@Controller
public class E10_SpringExpressionLanguageController {

	@GetMapping("/e10springexpressionlanguage")
	public String getSpringExpressionLanguagePage(ModelMap model) {
		...
		return "e10springexpressionlanguage";
	}
}

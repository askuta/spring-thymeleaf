...
@Controller
public class E02_SimpleFormattingController {

	@GetMapping("/e02simpleformatting")
	public String getSimpleFormattingPage(ModelMap model) {
